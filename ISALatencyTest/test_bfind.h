...
#pragma region "----- BFIND B32 CONSTANT TESTS -----"

...
#pragma region "----- BFIND B64 CONSTANT TESTS -----"

...
__device__ unsigned Bfind_u64_const_0x0000000000000000U(bool printresult)
{
	...
	asm("{                                               \n\t"
		...
		" mov.u32 %1, %%clock;                           \n\t"
		"}"
		: "=r"(start), "=r"(stop), "=r"(out32a));					                                // Different size registers need different letters.  l=64 bits, r=64 bits...
	if (printresult) printf("%s result = %u", __FUNCTION__, out32a);                                // When printresult is true, print the name of the function along with any results
	return stop - start - 42;
}
...
#pragma region "----- BFIND B32 REGISTER TESTS -----"

...
#pragma region "TEST INTEGRATIONCODE"
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////
